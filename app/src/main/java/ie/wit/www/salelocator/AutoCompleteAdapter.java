...
//                    Toast.makeText(, "Not Connected", Toast.LENGTH_LONG).show();
    ...
    private void displayPredictiveResults(String query) {
        ...
        com.google.android.gms.location.places.Places.GeoDataApi.getAutocompletePredictions(mGoogleApiClient, query, bounds, AutocompleteFilter.create(filterTypes))
                .setResultCallback(
